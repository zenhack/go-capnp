...
func (c PingPong) EncodeAsPtr(s *capnp.Segment) capnp.Ptr {
...
func (c StreamTest) EncodeAsPtr(s *capnp.Segment) capnp.Ptr {
	return c.Client.EncodeAsPtr(s)
}
...
func (c CapArgsTest) EncodeAsPtr(s *capnp.Segment) capnp.Ptr {
	return c.Client.EncodeAsPtr(s)
}
